...
export declare const QPlainTextEditEvents: Readonly<{
    textChanged: string;
    blockCountChanged: string;
    copyAvailable: string;
    cursorPositionChanged: string;
    modificationChanged: string;
    redoAvailable: string;
...
export declare class QPlainTextEdit extends QAbstractScrollArea {
