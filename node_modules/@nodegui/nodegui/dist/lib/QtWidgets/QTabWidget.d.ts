...
export declare const QTabWidgetEvents: Readonly<{
    currentChanged: string;
    tabBarClicked: string;
    tabBarDoubleClicked: string;
    tabCloseRequested: string;
    None: string;
    ActionAdded: string;
...
export declare class QTabWidget extends NodeWidget {
